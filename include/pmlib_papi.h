...
struct pmlib_papi_chooser {
	...
	std::string s_name[Max_chooser_events];	 // event symbol
};

// K computer has obsolete PAPI version 3.6
// Following macro are temporarily set to catch up with PAPI version 5+
